...
Game loop for step 36 of the 3D renderer: **texture plumbing**. Every mesh
...
stub — exactly as in the C — so textured modes draw only the wireframe for
now; the per-pixel texturing arrives in step 37.
"""
