...
def draw_textured_triangle(
    ...
    """Rasterize a triangle sampling colors from a texture.

    Step 36 only wires up the *plumbing* (UVs travel from the mesh through
    the pipeline to this call); the C function body is literally a TODO
    comment. The real per-pixel implementation arrives in step 37.
    """
    # TODO:
