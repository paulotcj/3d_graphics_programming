> **About this folder:** in the C original, `working/` is byte-identical to
> step 59 — it is the folder the course author actively worked in. The
> Python mirror keeps the same convention: this is an exact copy of
> [step 59](../59/3d_renderer/). The step-59 README follows.
