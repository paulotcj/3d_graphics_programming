...
Game loop for step 37 of the 3D renderer: **scanline triangle fill**. Every mesh
...
stub no more: step 37 implements the flat-bottom/flat-top scanline walk and
fills the triangle with a magenta checkerboard placeholder. Real texel
sampling (barycentric coordinates) arrives in step 38.
"""
