"""Step 23 — Loading the F-22 model (mirrors src/main.c).

Identical to the previous step except for one line: setup() now calls
``load_obj_file_data("./assets/f22.obj")`` and the geometry of the course's
F-22 jet is parsed from disk. The game loop is unchanged: rotate the mesh a
