...
Game loop for step 49 of the 3D renderer: **frustum planes**. A new
clipping.py defines the six planes of the view frustum (near, far, and the
four fov-tilted side planes, each a point + inward normal) and setup() now
initializes them alongside the projection matrix. Nothing is clipped yet —
the planes are scaffolding for steps 50-52. Default render mode switches to
wireframe (easier to watch clipping develop) and the scene loads
cube.obj/cube.png.
"""
...
import display
from clipping import init_frustum_planes
from display import (
    FPS,
    clear_color_buffer,
    clear_z_buffer,
